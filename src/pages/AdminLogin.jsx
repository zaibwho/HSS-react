    ...
    <Layout>
      <div className="authContainer">
        <div className="authBox">
          <h1>Admin Portal</h1>
          <p style={{ color: 'var(--gray-600)', marginBottom: '2rem' }}>Administrator sign in</p>
          ...
          <div style={{ marginTop: '2rem', textAlign: 'center', borderTop: '1px solid var(--gray-200)', paddingTop: '1.5rem' }}>
            ...
            <p style={{ color: 'var(--gray-600)', marginBottom: '0.5rem' }}>Are you a customer?</p>
            <Link to="/customer/login" style={{ color: 'var(--primary)', fontWeight: 500 }}>
              Customer Sign In →
            </Link>
          </div>
        </div>
